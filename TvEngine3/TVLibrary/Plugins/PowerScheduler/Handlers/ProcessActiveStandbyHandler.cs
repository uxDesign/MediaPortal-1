      ...
      switch (args.EventType)
      {
        ...
        case PowerSchedulerEventType.Elapsed:
            ...
            if (!IsEqual(processList, setting.Get<List<string>>()))
          {
              ...
              Log.PSDebug("ProcessActiveHandler: Preventing standby for processes: {0}", processes);
          }
          ...
          if (setting.Get<bool>() != _checkForMPClientRunning)
          {
             ...
             Log.PSDebug("ProcessActiveHandler: Prevent standby when MP client is not running : {0}", _checkForMPClientRunning);
          }
          ...
          if (setting.Get<bool>() != _useAwayMode)
          {
            ...
            Log.PSDebug("ProcessActiveHandler: Use away mode: {0}", _useAwayMode);
          }
